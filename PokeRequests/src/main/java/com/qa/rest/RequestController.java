...
public class RequestController {
	...
	@GetMapping(value = "/getNum/{number}")
	public ResponseEntity<Object> getPokeByNum(@PathVariable("number") int num){
		...
		return restTemplate.exchange("https://pokeapi.co/api/v2/pokemon/"+num, HttpMethod.GET, entity, Object.class);
